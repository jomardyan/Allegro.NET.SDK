...
public class AdditionalEmailsClientTests : IDisposable
{
    private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly AllegroHttpClient _allegroHttpClient;
    private readonly AdditionalEmailsClient _client;

    public AdditionalEmailsClientTests()
    {
        ...
        _client = new AdditionalEmailsClient(_allegroHttpClient);
    }
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new AdditionalEmailsClient(null!));
    }
}
