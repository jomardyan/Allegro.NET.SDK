...
public class CustomerReturnsClientTests : IDisposable
{
    private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly AllegroHttpClient _allegroHttpClient;
    private readonly CustomerReturnsClient _client;

    public CustomerReturnsClientTests()
    {
        ...
        _client = new CustomerReturnsClient(_allegroHttpClient);
    }
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new CustomerReturnsClient(null!));
    }
}
